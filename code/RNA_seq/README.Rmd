...
```{r, Control vs VP64_p65_no_guide baseline vs LFC, results = FALSE, message=FALSE, warning=FALSE}
...
```{r, Control vs VP64_vp64_no_guide baseline vs LFC, results = FALSE, message=FALSE, warning=FALSE}
...
```{r, Condition_VP64_p65_with_guide_vs_VP64_p65_no_guide baseline vs LFC, results = FALSE, message=FALSE, warning=FALSE}
...
```{r, Condition_VP64_VP64_with_guide_vs_VP64_VP64_no_guide baseline vs LFC, results = FALSE, message=FALSE, warning=FALSE}
...
```{r VP64_p65_with_guide with VP64_p65_no_guide gene 50kbs, echo=FALSE, warning=FALSE}
...
```{r VP64_VP64_with_guide with VP64_VP64_no_guide gene 50kbs, echo=FALSE, warning=FALSE}
